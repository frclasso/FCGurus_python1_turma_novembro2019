...
# ADIDAS
name = germany_companies[12]
industry = germany_companies[13]
sector = germany_companies[14]
headquarters = germany_companies[15]
founded = germany_companies[16]
notes = germany_companies[17]

print("Sobre a empresa: {},tipo {},do setor:{},localizada em :{},fundada em: {}\
 - mais informacoes: {}".format(name,
 								industry,
 								sector,
 								headquarters,
 								founded,
...
#TAREFA IMPRIMIR:
# NAME, FOUNDED, HEADQUARTES - DE CADA EMPRESA
